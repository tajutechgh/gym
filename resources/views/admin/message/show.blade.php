                ...
                <div class="col-xlg-10 col-lg-9 col-md-8 bg-light-part b-l">
                    <div class="card-body p-t-0">
                        <div class="card b-all shadow-none">
                            <div class="card-body">
                                <h3 class="card-title m-b-0">Sent Message Details</h3>
                            </div>
                            <div>
                                <hr class="m-t-0">
                            </div>
                            <div class="card-body">
                                <div class="d-flex m-b-40">
                                    <div class="p-l-10">
                                        <h4 class="m-b-0 fa fa-user"> {{$message->member['name']}}</h4><br>
                                        <small class="text-muted fa fa-phone"> {{$message->phone}}</small>
                                    </div>
                                </div>
